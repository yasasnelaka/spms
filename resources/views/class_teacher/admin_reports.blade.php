...
{{--              <li class="nav-item">--}}
{{--                <a class="nav-link active" href="http://localhost/spms/public/reports/">--}}
   ...
   function drawChart()
   {
    ...
    var options = {
     title : '<?php echo $chart_title; ?>',
      vAxis: {title: '<?php echo $vaxis; ?>'},
      hAxis: {title: '<?php echo $haxis; ?>'},
      bar: { groupWidth: '25%' }
    };

    var chart = new google.visualization.<?= $chart_type;?>(document.getElementById('pie_chart'));
