...
@section('content')
    ...
    <center>
        <div class="container-fluid">
            <form action="{{url('/class_teacher/view_marks')}}" method="get">
                ...
                <div class="col-md-4">
                    <select class="mdb-select md-form" name="subject_id" searchable="Search here..">
                ...
                <div class="col-md-4">
                    <input type="submit" class="btn btn-primary" value="Check  marks" id="submit" name="submit">
                </div>
            </form>
    </center>
    <script>
