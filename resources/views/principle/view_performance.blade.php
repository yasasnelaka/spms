...
@section('content')
    <div class="container-fluid">
        ...
        @endif
       <form action="/principle/view_filter_performance_form" method="get">
...
{{--                    <td>{{$student->event}}</td>--}}
                    ...
                    <td>{{$student->grade}}</td>
                    <td>
                        <form  action="{{url('/principle/update_performance')}}" method="get">
                            <input type="hidden" name="id" value="{{$student->id}}">
                            <button class="btn btn-sm btn-warning" type="submit" name="submit">Update</button>
                        </form>
                    </td>
                    <td>
                        <form  action="{{url('/principle/delete_performance')}}" method="post">
                            {{ method_field('DELETE') }}
                            @csrf
