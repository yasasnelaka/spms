...
@section('content')
    ...
    @foreach($notifi as $find)
        <div role="alert" aria-live="assertive" aria-atomic="true" class="toast  container" style="position: relative;  min-width: 60%" data-autohide="false">
